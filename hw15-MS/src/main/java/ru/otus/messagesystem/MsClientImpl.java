...
public class MsClientImpl implements MsClient {
    ...
    private final MessageSystem messageSystemss;
    private final Map<String, RequestHandler> handlers = new ConcurrentHashMap<>();


    public MsClientImpl(String name, MessageSystem messageSystemss) {
        this.name = name;
        this.messageSystemss = messageSystemss;
    }
    ...
    public boolean sendMessage(Message msg) {
        boolean result = messageSystemss.newMessage(msg);
        if (!result) {
